...
import com.ruide.subway.network.BaseObserverListener;
...
public abstract class RxObserverListener<T> implements BaseObserverListener<T> {
    ...
    protected RxObserverListener(IView view) {
        this.mView = view;
    }
    ...
    public void onError(Throwable e) {
        ...
        if (mView != null) {
            ...
            Toast.makeText(BaseApplication.getInstance(), responseThrowable.message, Toast.LENGTH_SHORT);
        }
    }
